  ...
  return (
    ...
    <section class="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:px-8">
      <div class="absolute"></div>
        <div class="absolute shadow-xl shadow-indigo-600/10 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center"></div>
      ...
      <div class="py-24 sm:py-32 bg-slate-500/5 ">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <h2 class="text-center text-lg font-semibold leading-8 text-gray-400">With great help from these sources</h2>
